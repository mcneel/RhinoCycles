...
namespace RhinoCyclesCore.Settings
{
	...
	public class DeviceSection : ApplicationSection
	{
		...
		private void InitializeComponents()
		{
			...
			m_tabpage_metal = new GridDevicePage { Text = "Metal", Image = Eto.Drawing.Icon.FromResource("RhinoCyclesCore.Icons.CUDA.ico").WithSize(16, 16), ToolTip = Localization.LocalizeString("Show all the render devices in the Metal category.\nThese include GPU devices on MacOS systems.", 26) };
			m_tabpage_hip = new GridDevicePage { Text = "HIP", Image = Eto.Drawing.Icon.FromResource("RhinoCyclesCore.Icons.CPU.ico").WithSize(16, 16), ToolTip = Localization.LocalizeString("Show all the render devices in the HIP category.\nThese include AMD GPU and supported devices.", 78) };
			m_tabpage_oneapi = new GridDevicePage { Text = "OneAPI", Image = Eto.Drawing.Icon.FromResource("RhinoCyclesCore.Icons.CPU.ico").WithSize(16, 16), ToolTip = Localization.LocalizeString("Show all the render devices in the OneAPI category.\nThese include Intel GPU and supported devices.", 79) };
