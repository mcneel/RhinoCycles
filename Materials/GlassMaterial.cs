...
namespace RhinoCyclesCore.Materials
{
	...
	public class GlassMaterial : RenderMaterial, ICyclesMaterial
	{
		...
		public bool GetShader(ccl.Shader sh, bool finalize)
		{
			...
			Utilities.PbrGraphForSlot(sh, Color, ColorTexture, glass.ins.BaseColor.ToList(), texco);
			Utilities.PbrGraphForSlot(sh, Color, ColorTexture, transp.ins.Color.ToList(), texco);
			Utilities.PbrGraphForSlot(sh, Frost, FrostTexture, glass.ins.TransmissionRoughness.ToList(), texco);
			Utilities.PbrGraphForSlot(sh, Frost, FrostTexture, glass.ins.IOR.ToList(), texco);
