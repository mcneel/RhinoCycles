	...
	public class CyclesShader
	{
		...
		private bool CreateShaderPart(ShaderBody shb, RenderMaterial rm, float gamma)
		{
			...
			if (pbrbasecol.Value != null)
			{
				...
				Utilities.HandleRenderTexture(shb.PbrSubsurface.Texture, shb.PbrSubsurfaceTexture, 1.0f);
				...
				Utilities.HandleRenderTexture(shb.PbrSubsurfaceRadius.Texture, shb.PbrSubsurfaceRadiusTexture, 1.0f);
				rm.HandleTexturedValue(Pbr.Roughness, shb.PbrRoughness);
				Utilities.HandleRenderTexture(shb.PbrRoughness.Texture, shb.PbrRoughnessTexture, 1.0f);
				rm.HandleTexturedValue(Pbr.Specular, shb.PbrSpecular);
				Utilities.HandleRenderTexture(shb.PbrSpecular.Texture, shb.PbrSpecularTexture, 1.0f);
				rm.HandleTexturedValue(Pbr.SpecularTint, shb.PbrSpecularTint);
				Utilities.HandleRenderTexture(shb.PbrSpecularTint.Texture, shb.PbrSpecularTintTexture, 1.0f);
				rm.HandleTexturedValue(Pbr.Anisotropic, shb.PbrAnisotropic);
				Utilities.HandleRenderTexture(shb.PbrAnisotropic.Texture, shb.PbrAnisotropicTexture, 1.0f);
				rm.HandleTexturedValue(Pbr.AnisotropicRotation, shb.PbrAnisotropicRotation);
				Utilities.HandleRenderTexture(shb.PbrAnisotropicRotation.Texture, shb.PbrAnisotropicRotationTexture, 1.0f);
				rm.HandleTexturedValue(Pbr.Sheen, shb.PbrSheen);
				Utilities.HandleRenderTexture(shb.PbrSheen.Texture, shb.PbrSheenTexture, 1.0f);
				rm.HandleTexturedValue(Pbr.SheenTint, shb.PbrSheenTint);
				Utilities.HandleRenderTexture(shb.PbrSheenTint.Texture, shb.PbrSheenTintTexture, 1.0f);
