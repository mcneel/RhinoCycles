...
namespace RhinoCycles.Commands
{
	...
	{
		static TestCreateMultiOpenCl _instance;
		public TestCreateMultiOpenCl()
		{
			if(_instance==null) _instance = this;
		}

		///<summary>The only instance of the TestCreateMultiOpenCl command.</summary>
		public static TestCreateMultiOpenCl Instance => _instance;

		public override string EnglishName => "TestCreateMultiOpenCl";
